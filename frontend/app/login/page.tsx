    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 24 }}>
          <a 
            href={acceptTerms ? `${API_BASE}/login/google` : '#'}
            onClick={(e) => {
              if (!acceptTerms) {
                e.preventDefault();
                alert('Please accept the Terms of Service to continue');
          ...
          <a 
            href={acceptTerms ? `${API_BASE}/login/microsoft` : '#'}
            onClick={(e) => {
              if (!acceptTerms) {
                e.preventDefault();
                alert('Please accept the Terms of Service to continue');
        ...
        {/* Terms acceptance for all methods */}
        <div style={{ 
          display: 'flex', 
          alignItems: 'center', 
          gap: 8, 
          ...
          <input
            ...
            style={{ margin: 0 }}
          />
          <label htmlFor="globalTerms" style={{ cursor: 'pointer' }}>
